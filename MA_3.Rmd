...
NP_turnover<-rep(0,T)
HEA_turnover<-rep(0,T)
NSS_turnover<-rep(0,T)

NP_TC<-rep(0,T)
HEA_TC<-rep(0,T)
NSS_TC<-rep(0,T)

for(i in 1:2){ #Begin for loop for monthly portfolio estimation
  
#Estimate Sigma and mu using data from the last 12 months
window_length<-12
