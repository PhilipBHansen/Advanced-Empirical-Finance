...
mom_portfolios %>% group_by(portfolio) %>%
  ...
  knitr::kable(booktabs = T, digits = 2, col.names = c("Portfolio number", "Average momentum", "Average market capitalization"), caption = "Equal weighted momentum-sorted portfolios with average momentum and market capitalization for each") %>% 
  kable_paper("hover", full_width = T) %>% 
  kable_styling(latex_options = "HOLD_position")
